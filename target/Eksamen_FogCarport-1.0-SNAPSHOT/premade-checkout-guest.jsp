        ...
        <div class="order-summary">
            ...
            <div class="item-subtotal">
                <div class="item-subtotal-container">
                    <p class="p-space"><span class="span-left">Item Subtotal</span> <span class="span-right">${sessionScope.viewMoreCarport.price}00</span></p>
            ...
            <div class="order-total">
                <p><span class="span-left">ORDER TOTAL</span> <span class="span-right">${sessionScope.viewMoreCarport.price}00</span></p>
            </div>
        ...
        <div class="cart-summary">
            <div class="order-header">
                ...
                <div class="order-right">
                    ...
                    <p class="small-p">${sessionScope.viewMoreCarport.price}00</p>
                </div>
            </div>
        </div>
    </div>
