    ...
    <div class="input-con">
        <form action="DesignController" method="post">
            <div class="section-select">
                <label for="carport_width">Carport width</label>
                ...
                <select name="roof" id="carport_roof">
                    <optgroup label="Roof">
                        ...
                        <option value="1">Flat-roof, Asphalt roofing </option>
                        <option value="2">Flat-roof, Trapez Plastic</option>
                    </optgroup>
                </select>
            ...
            <br>
            <button type="submit" value="flatCookie" name="calculate">Calculate</button>
        </form>
    </div>
    <br>
</div>
