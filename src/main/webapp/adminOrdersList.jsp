...
<h1 class="material-list-header">All Orders in Fog's Database</h1>
    ...
    <table>
        ...
        <c:forEach var="order" items="${requestScope.allOrders}">
            <tr>
                ...
                <td>${order.user_id}</td>
                <td>${order.price}</td>
                <td>${order.carport_width}</td>
                <td>${order.carport_length}</td>
                <td>${order.claddingType}</td>
                <td>${order.roofingType}</td>
                <td>${order.shed_width}</td>
                <td>${order.shed_length}</td>
            </tr>
        </c:forEach>
    </table>
