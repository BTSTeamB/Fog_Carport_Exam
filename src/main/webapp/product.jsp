...
<div class="container">
    <div class="carousel">
        <div class="carousel__item">
            <img src="Resources/images/carport1.0.jpg" alt="image of carport1">
        </div>
        <div class="carousel__item">
            <img src="Resources/images/carport1.1.jpg" alt="image of carport2">
        </div>
        <div class="carousel__item">
            <img src="Resimages/carport1.2.jpg" alt="image of carport2">
        </div>
    ...
    <div class="option-widget">
        ...
        <div class="user-choice">
            <form action="">
                    ...
                    <div class="cladding">
                        ...
                        <div class="cladding-item">
                            <div class="donate-now">
                                <li>
                                    <input type="radio" name="cladding" id="stone">
                                    <label class="donate-item label-left" for="stone">Stone</label>
                                    <label class="donate-item label-right" for="stone">+ kr. 1.500,000</label>
                                </li>
                                <br>
                                <br>
                                <li>
                                    <input type="radio" name="cladding" id="wood">
                                    <label class="donate-item label-left" for="wood">Metal</label>
                                    <label class="donate-item label-right" for="wood">+ kr. 1.000,000</label>
                                </li>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset class="form-field" id="roofing">
                    <div class="roofing">
                        ...
                        <div class="roofing-item">
                            ...
                            <div class="donate-now">
                                <li>
                                    <input type="radio" name="roofing" id="stone2">
                                    <label class="donate-item label-left" for="stone2">Stone</label>
                                    <label class="donate-item label-right" for="stone2">+ kr. 1.500,000</label>
                                </li>
                                <br>
                                <br>
                                <li>
                                    <input type="radio" name="roofing" id="wood2">
                                    <label class="donate-item label-left" for="wood2">Metal</label>
                                    <label class="donate-item label-right" for="wood2">+ kr. 1.000,000</label>
                                </li>
                            </div>
                        </div>
                    </div>
                ...
                <div class="button-container">
                    <button type="submit" class="button-container-item">Countinue</button>
                </div>
            </form>
        </div>
        ...
        <div class="des-container2">
            ...
            <br>
            <p>
                Krister er en carport til din bil, og den giver dig samtidig et smart, laftekonstrueret redskabsskur på 8 kvm,
                hvor du kan opbevare sommer-/vinterdæk, biltilbehør, havemøbler og cykler. Bilen bliver beskyttet af sadeltaget og
                to vægge, der forhindrer sneen i at fyge, og som derudover kan bruges til at sætte hylder og kroge på, så man får ekstra
                opbevaringsmuligheder. Taget på Krister har en høj bæreevne i forhold til sne, til forskel fra den lignende model Lennart.
                <br>
                <br>
                Bygningen leveres som et byggesæt. Du får selv lov at samle carporten ved hjælp af vores monteringsvejledning og de
                medfølgende skruer og søm. Er du en lille smule handy, eller har gode venner, bliver det et cool projekt.
                <br>
                <br>
                Redskabsskuret har et gulv i form af brædder på bjælker. I carportdelen skal du selv vælge, om du vil
                lægge betonplader, asfaltere eller ønsker grus. Du vælger også selv tagbelægning og farve, da der ikke medfølger
                tagpap, tagplader, shingel eller tegl, og træet er desuden ubehandlet. Du ved bedst, hvilke farver og materialer der
                passer til grunden.
            </p>
        </div>
